...
public class EstiloMemoria extends DefaultMetalTheme{
	public String getName() { return "EstiloMemoria"; }
	   ...
	   private final ColorUIResource secondary3 = new ColorUIResource(0, 0, 0);
